...
<html lang="es">
    ...
    <body>
        ...
        <form action="<%=request.getContextPath()%>/ControladorEdificios" method="POST">
            <div style="margin-left: 20px">
                ...
                <select class="form-select" aria-label="Default select example" name="tipoEdificio">
                ...
                <select class="form-select" aria-label="Default select example" name="numHabitaciones">
                ...
                <select class="form-select" aria-label="Default select example" name="fechaConstruccion">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="tipoConstruccion" id="flexRadioDefault1" value="1" checked>
                    <label class="form-check-label" for="flexRadioDefault1">
                      Madera
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="tipoConstruccion" id="flexRadioDefault2" value="2">
                ...
                <select class="form-select" aria-label="Default select example" name="valorMercado">
